...
const publicationChairs: CommitteeMember[] = [
  { name: "Dr. Sibarama Panigrahi", role: "Publication Chair", affiliation: "NIT, Rourkela" },
  { name: "Dr. Rudranarayan Pradhan", role: "Publication Chair", affiliation: "OUTR, Bhubaneswar" },
  { name: "Dr. Gajendra Kant Mishra", role: "Publication Chair", affiliation: "BIT, Mesra" },
  { name: "Dr. Nishant Kumar", role: "Publication Chair", affiliation: "B K Birla Institute, Pilani" },
  ...
  { name: "Dr. Jonaki Mukherjee", role: "Publication Chair", affiliation: "AJU, Jharkhand, India" },
];

const womenInEngineeringChairs: CommitteeMember[] = [
  { name: "Prof. (Dr.) Karabi Biswas", role: "WIE Chair", affiliation: "IIT, Kharagpur" },
  { name: "Prof. (Dr.) Susmita Das", role: "WIE Chair", affiliation: "NIT, Rourkela" },
  { name: "Prof. (Dr.) Renu Sharma", role: "WIE Chair", affiliation: "SOA, Bhubaneswar" },
    ...
    <>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <SectionHeading title="Advisory Committees" />
            <div className="space-y-12">
              <CommitteeTable title="International Advisory Committee" members={internationalAdvisoryCommittee} />
              <CommitteeTable title="National Advisory Committee" members={nationalAdvisoryCommittee} />
            </div>
          </div>
